...
class Valorizacionconcreto
{
  ...
  public function insertar_valorizacion($idproyecto, $nombre, $fecha_inicio, $fecha_fin, $numero_q_s, $doc) {
    $sql = "  INSERT INTO concreto_por_valorizacion(idproyecto, nombre_doc, numero_valorizacion, fecha_inicial, fecha_final, documento,user_created) 
    VALUES ('$idproyecto','$nombre','$numero_q_s','$fecha_inicio','$fecha_fin','$doc', '".$_SESSION['idusuario']."')";
    $new_valorizacion = ejecutarConsulta_retornarID($sql); if ( $new_valorizacion['status'] == false) {return $new_valorizacion; }

    //B I T A C O R A -------
    $sql_b = "INSERT INTO bitacora_bd( nombre_tabla, id_tabla, accion, id_user) VALUES ('concreto_por_valorizacion', '".$new_valorizacion['data']."', 'Crear registro', '".$_SESSION['idusuario']."')";
