...
class ServicioMaquina
{
  ...
  public function listar($nube_idproyecto)
  {
    ...
    WHERE s.estado = 1 AND  s.estado_delete= '1' AND s.idproyecto='$nube_idproyecto' AND m.tipo = 1 AND s.idmaquinaria=m.idmaquinaria AND m.idproveedor=p.idproveedor
