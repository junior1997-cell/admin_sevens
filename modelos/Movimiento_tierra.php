...
class Movimiento_tierra
{
  ...
  public function insertar_grupo($idproyecto, $nombre_item, $modulo, $columna_bombeado, $descripcion_item) {
  ...
  public function editar_grupo($idproyecto, $idtipo_tierra, $nombre_item, $modulo, $columna_bombeado, $descripcion_item) {
  ...
  public function listar_de_grupo($proyecto) {
  ...
  public function total_tierra($id_proyecto, $idtipo_tierra, $fecha_1, $fecha_2, $id_proveedor, $comprobante) {
  ...
  //Implementamos un método para desactivar categorías
  public function desactivar_tierra($idmovimiento_tierra) {
  ...
  //Implementamos un método para activar categorías
  public function eliminar_tierra($idmovimiento_tierra) {
    $sql = "UPDATE movimiento_tierra SET estado_delete='0' WHERE idmovimiento_tierra ='$idmovimiento_tierra'";
    return ejecutarConsulta($sql);  
  }
  
  public function mostrar_tierra($idmovimiento_tierra) {
  ...
  public function tbla_principal_resumen($idproyecto) {
    ...
    AND cpp.idproyecto = '$idproyecto'  AND cpp.estado = '1' AND cpp.estado_delete = '1' AND ttc.modulo ='Movimiento de Tierras'
