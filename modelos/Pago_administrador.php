...
Class PagoAdministrador
{
	...
	{
		$sql="SELECT t.idtrabajador, t.nombres, t.tipo_documento, t.numero_documento, t.cuenta_bancaria, t.cci, t.imagen_perfil, t.telefono,
	...
	{
		$sql="SELECT idfechas_mes_pagos, idtrabajador_por_proyecto, fecha_inicial, fecha final, dias_mes, sueldo, monto
		FROM fechas_mes_pagos WHERE idtrabajador_por_proyecto = '$idtrabajador_x_proyecto' AND estado = 1;";
