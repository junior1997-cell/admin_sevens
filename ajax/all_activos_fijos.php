      ...
      switch ($_GET["op"]) {
        ...
        case 'guardaryeditarcompraactivo':
          ...
          if (empty($idcompra_af_general)) {
            ...
            $rspta = $all_activos_fijos->insertar( $idproveedor, $fecha_compra, $tipo_comprovante, $serie_comprovante, $descripcion, $subtotal_compra,
            $igv_compra, $total_compra_af_g, $_POST["idactivos_fijos"], $_POST["unidad_medida"], $_POST["nombre_color"], $_POST["cantidad"],
            $_POST["precio_sin_igv"], $_POST["precio_igv"], $_POST["precio_con_igv"], $_POST["descuento"], $_POST["ficha_tecnica_activo"] );
            
            echo $rspta ? "ok" : "No se pudieron registrar todos los datos de la compra";
      
          } else {
      
            $rspta = $all_activos_fijos->editar( $idcompra_af_general, $idproveedor, $fecha_compra, $tipo_comprovante, $serie_comprovante, $descripcion,
            $subtotal_compra, $igv_compra, $total_compra_af_g, $_POST["idactivos_fijos"], $_POST["unidad_medida"], $_POST["nombre_color"], $_POST["cantidad"], 
            $_POST["precio_sin_igv"], $_POST["precio_igv"], $_POST["precio_con_igv"], $_POST["descuento"], $_POST["ficha_tecnica_activo"] );
        ...
        case 'guardar_y_editar_materiales':
          ...
          if (empty($idproducto_p)) {
            ...
            $rspta = $all_activos_fijos->insertar_material( $unidad_medida_p, $color_p, $categoria_insumos_af_p, $nombre_p, $modelo_p,
        ...
        case 'listar_compra_activos':
          if (!isset($_SESSION["nombre"])) {
            ...
            if ($_SESSION['activo_fijo_general'] == 1) {
              ...
              $tool = '"tooltip"';   $toltip = "<script> $(function () { $(\'[data-toggle=\' \']\').tooltip(); }); </script>";
              ...
              foreach ($rspta as $key => $reg) {
                ...
                $data[] = [
                  "0" => $cont,
                  "1" => empty($reg['idproyecto']) ? ($reg['estado'] == '1'  ? '<button class="btn btn-info btn-sm" onclick="ver_compras_af_g(' .
                        $reg['idtabla'] . ')" data-toggle="tooltip" data-original-title="Ver detalle compra"><i class="fa fa-eye"></i></button>' .
                        ' <button class="btn btn-warning btn-sm" onclick="editar_detalle_compras(' .
                        $reg['idtabla'] .
                        ')" data-toggle="tooltip" data-original-title="Editar compra"><i class="fas fa-pencil-alt"></i></button>' .
                        ' <button class="btn btn-danger btn-sm" onclick="anular(' .
                        $reg['idtabla'] .
                        ')" data-toggle="tooltip" data-original-title="Anular Compra"><i class="fas fa-times"></i></button>' .
                        ' <button class="btn btn-danger  btn-sm" onclick="eliminar_compra(' .
                        $reg['idtabla'] .
                        ')"><i class="fas fa-skull-crossbones"></i> </button>'
                      : '<button class="btn btn-info btn-sm" onclick="ver_compras_af_g(' .
                        $reg['idtabla'] .
                        ')"data-toggle="tooltip" data-original-title="Ver detalle"><i class="fa fa-eye"></i></button>' .
                        ' <button class="btn btn-success btn-sm" onclick="des_anular(' .
                        $reg['idtabla'] .
                        ')" data-toggle="tooltip" data-original-title="Recuperar Compra"><i class="fas fa-check"></i></button>')
                    : ($reg['estado'] == '1'
                      ? '<button class="btn btn-info btn-sm " onclick="ver_compras_af_p(' .
                        $reg['idtabla'] .
                        ')" data-toggle="tooltip" data-original-title="Ver detalle compra"><i class="fa fa-eye"></i></button>' .
                        ' <button class="btn btn-warning btn-sm" disabled onclick="editar_detalle_compras_af_p(' .
                        $reg['idtabla'] .
                        ')" data-toggle="tooltip" data-original-title="Editar compra"><i class="fas fa-pencil-alt"></i></button>' .
                        ' <button class="btn btn-danger btn-sm" disabled onclick="anular_af_p(' .
                        $reg['idtabla'] .
                        ')" data-toggle="tooltip" data-original-title="Anular Compra"><i class="fas fa-times"></i></button>' .
                        ' <button class="btn btn-danger  btn-sm" disabled onclick="eliminar_compra(' .
                        $reg['idtabla'] .
                        ')"><i class="fas fa-skull-crossbones"></i> </button>'
                      : '<button class="btn btn-info btn-sm" disabled onclick="ver_compras_af_p(' .
                        $reg['idtabla'] .
                        ')"data-toggle="tooltip" data-original-title="Ver detalle"><i class="fa fa-eye"></i></button>' .
                        ' <button class="btn btn-success btn-sm" disabled onclick="des_anular_af_p(' .
                        $reg['idtabla'] .
                        ')" data-toggle="tooltip" data-original-title="Recuperar Compra"><i class="fas fa-check"></i></button>'),
                  ...
                  "4" =>
                    '<div class="user-block">
                                          <span class="description" style="margin-left: 0px !important;"><b>' .
                    (empty($reg['idproyecto']) ? 'General' : $reg['codigo_proyecto']) .
                    '</b></span>
                                          <span class="username" style="margin-left: 0px !important;"><p class="text-primary"style="margin-bottom: 0.2rem !important"; >' .
                    $reg['razon_social'] .
                    '</p></span>
                                          <span class="description" style="margin-left: 0px !important;"><b>Cel: </b><a class="text-body" href="tel:+51' .
                    quitar_guion($reg['telefono']) .
                    '" data-toggle="tooltip" data-original-title="Llamar al proveedor.">' .
                    $reg['telefono'] .
                    '</a> </span>
                  ...
                  "5" =>
                    '<div class="user-block">
                                      <span class="username" style="margin-left: 0px !important;"><p style="margin-bottom: 0.2rem !important"; >' .
                    $tipo_comprobante1 .
                    '</p></span>
                                      <span class="description" style="margin-left: 0px !important;">Número: ' .
                    $serie_comprobante .
                    ' </span>
                                  </div>',
                  "6" => number_format($reg['total'], 2, '.', ','),
                  "7" => empty($reg['idproyecto'])
                    ? '<div class="text-center text-nowrap"> <button class="btn btn-' .
                      $c .
                      ' btn-xs m-t-2px" onclick="listar_pagos_af_g(' .
                      $reg['idtabla'] .
                      ',' .
                      $reg['total'] .
                      ',' .
                      floatval($reg['deposito']) .
                      ')">
                                      <i class="fas fa-' .
                      $icon .
                      ' nav-icon"></i> ' .
                      ...
                      $cc .
                      ' btn-sm">' .
                      number_format(floatval($reg['deposito']), 2, '.', ',') .
                      '</button></div>'
                    : '<div class="text-center text-nowrap"> <button class="btn btn-' .
                      $c .
                      ' btn-xs m-t-2px" disabled onclick="listar_pagos(' .
                      $reg['idtabla'] .
                      ',' .
                      $reg['total'] .
                      ',' .
        ...
        case 'listar_detalle_compraxporvee':
          if (!isset($_SESSION["nombre"])) {
            ...
            if ($_SESSION['activo_fijo_general'] == 1) {
              ...
              foreach ($rspta as $key => $value) {
                $data[] = [
                  "0" => empty($value['idproyecto'])
                    ? '<center><button class="btn btn-info btn-sm" onclick="ver_compras_af_g(' . $value['idtabla'] . ')" data-toggle="tooltip" data-original-title="Ver detalle">Ver detalle <i class="fa fa-eye"></i></button></center>'
                  ...
                  "2" =>
                    '<div class="user-block">
                                      <span class="username" style="margin-left: 0px !important;"><p class="text-primary"style="margin-bottom: 0.2rem !important"; >' .
                    (empty($value['idproyecto']) ? 'General' : $value['codigo_proyecto']) .
                    '</p></span>                                   
                                      </div>',
                  "3" =>
                    '<div class="user-block">
            ...
            if ($_SESSION['activo_fijo_general'] == 1) {
              ...
              while ($reg = $rspta->fetch_object()) {
                ...
                echo '<tr class="filas">
                  ...
                  '</td>
                                          <td>' .
                  number_format($reg->precio_con_igv, 2, '.', ',') .
                  '</td>
                                          <td>' .
                  number_format($reg->descuento, 2, '.', ',') .
                  '</td>
                                          <td>' .
          ...
          if (!isset($_SESSION["nombre"])) {
            ...
            if ($_SESSION['activo_fijo_general'] == 1) {
              ...
              while ($reg = $rspta->fetch_object()) {
                ...
                $datas[] = [
                  "0" =>
                    '<button class="btn btn-warning" onclick="agregarDetalleCompraActivos(' .
                    $reg->idproducto .
                    ', \'' .
                    $reg->nombre .
                    '\', \'' .
                  ...
                  "1" =>
                    ...
                    $reg->nombre .
                    '</p></span>
                                      <span class="description"><b>Color: </b>' .
                    $reg->nombre_color .
                    '</span>
                                  </div>',
                  "2" => $reg->marca,
              ...
              while ($reg = $rspta->fetch_object()) {
                ...
                $data[] = [
                  ...
                  "3" =>
                    ...
                    $reg->beneficiario .
                    '</p></span>
                              <span class="description" style="margin-left: 0px !important;" data-toggle="tooltip" data-original-title="' .
                    $reg->titular_cuenta .
                    '"><b>titular: </b>' .
                    $titular_cuenta .
                    '</span></div>',
