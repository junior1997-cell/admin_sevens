		  ...
		  header("Location: ../vistas/login.html");//Validamos el acceso solo a los usuarios logueados al sistema.
			...
			if ($_SESSION['recurso']==1)
			{
				...
				if (empty($idmaquinaria)){
					$rspta=$all_maquinaria->insertar($nombre_maquina,$codigo_m);
					echo $rspta ? "ok" : "No se pudieron registrar todos los datos de maquinaria";
				}
				else {
					$rspta=$all_maquinaria->editar($idmaquinaria,$nombre_maquina,$codigo_m);
					echo $rspta ? "ok" : "Máquina no se pudo actualizar";
				}
