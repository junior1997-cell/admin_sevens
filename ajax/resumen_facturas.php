            ...
            foreach ($rspta['data']['datos'] as $key => $value) {
              ...
              $data[] = [
                ...
                "1" => '<div class="text-nowrap"> ' . 
                  '<button class="btn btn-info btn-sm" onclick="detalle_'.$value['carpeta'].'('.$value['idtabla'].','.$add_remove_vb_rf.')" data-toggle="tooltip" data-original-title="Ver detalle"><i class="fas fa-eye"></i></button>'.
