    ...
    if ($_SESSION['servicio_maquina'] == 1) {
      ...
      switch ($_GET["op"]) {
        ...
        case 'desactivar':
          ...
          $rspta = $serviciomaquina->desactivar($_GET['id_tabla']);
        ...
        case 'eliminar':
          ...
          $rspta = $serviciomaquina->eliminar($_GET['id_tabla']);
          echo json_encode($rspta,true);
        ...
        case 'guardaryeditar_pago':
          ...
          if (empty($idpago_servicio)) {
            ...
            $rspta = $serviciomaquina->insertar_pago( $idproyecto_pago, $beneficiario_pago, $forma_pago, $tipo_pago, $cuenta_destino_pago, $banco_pago,
            ...
            $rspta = $serviciomaquina->editar_pago($idpago_servicio, $idproyecto_pago, $beneficiario_pago, $forma_pago, $tipo_pago, $cuenta_destino_pago, $banco_pago,
              $titular_cuenta_pago, $fecha_pago, $monto_pago, $numero_op_pago, $descripcion_pago, $id_maquinaria_pago, $imagen1 );
        ...
        case 'activar_pagos':
          ...
          $rspta = $serviciomaquina->activar_pagos($_GET['id_tabla']);
          echo json_encode($rspta,true);
        ...
        case 'eliminar_pagos':
          ...
          $rspta = $serviciomaquina->eliminar_pagos($_GET['id_tabla']);
          echo json_encode($rspta,true);
        ...
        case 'desactivar_factura':
          ...
          $rspta = $serviciomaquina->desactivar_factura($_GET['id_tabla']);
          echo json_encode($rspta,true);
        ...
        case 'eliminar_factura':
          ...
          $rspta = $serviciomaquina->eliminar_factura($_GET['id_tabla']);
          echo json_encode($rspta,true);
