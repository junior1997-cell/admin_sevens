    ...
    if ($_SESSION['recurso'] == 1) {
      ...
      switch ($_GET["op"]) {        
        ...
        case 'tabla_principal':
          ...
          $rspta = $resumen_gasto->facturas_compras($_GET['id_proyecto'], $_GET['fecha_1'], $_GET['fecha_2'], $_GET['id_proveedor'], $_GET['comprobante'] );
        ...
        case 'data_comprobantes':                  
          ...
          $rspta = $resumen_gasto->facturas_compras($_POST['id_proyecto'], $_POST['fecha_1'], $_POST['fecha_2'], $_POST['id_proveedor'], $_POST['comprobante'] );
        ...
        case 'ver_detalle_compras_Insumos':
          ...
          $rspta = $compra_insumo->ver_compra($_GET['id_compra']);
          $rspta2 = $compra_insumo->ver_detalle_compra($_GET['id_compra']);
