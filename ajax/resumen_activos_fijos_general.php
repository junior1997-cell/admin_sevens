...
if (!isset($_SESSION["nombre"])) {
  ...
  if ($_SESSION['resumen_activo_fijo_general'] == 1) {
    ...
    switch ($_GET["op"]) {
      ...
      case 'guardar_y_editar_compra_general':
      ...
      case 'guardar_y_editar_compra_proyecto':
