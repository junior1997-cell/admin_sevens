    ...
    if ($_SESSION['compra_insumos'] == 1) {
      ...
      switch ($_GET["op"]) {  
        ...
        case 'tbla_principal':
          ...
          $rspta = $almacen->tbla_principal($idproyecto);
        ...
        case 'listarMaterialescompra':     
          ...
          $rspta = $almacen->listar_productos();
          //Vamos a declarar un array
          $datas = [];
        ...
        case 'actualizar_grupo':
          ...
          $rspta = $almacen->actualizar_grupo( $_POST["idproducto_g"], $_POST["idclasificacion_grupo_g"]);
          //var_dump($idactivos_fijos,$idproveedor);
          echo json_encode($rspta, true);          
        ...
        case 'tbla_facturas':
          ...
          $rspta = $almacen->tbla_facturas($idproyecto, $idproducto);
          //Vamos a declarar un array
          $data = []; $cont = 1;
        ...
        case 'sumas_factura_x_material':
          $rspta = $almacen->sumas_factura_x_material($_POST["idproyecto"], $_POST["idproducto"]);
          //Codificar el resultado utilizando json
          echo json_encode($rspta, true);
        ...
        case 'suma_total_compras':
          ...
          $rspta = $almacen->suma_total_compras($idproyecto);
