  ...
  if (!isset($_SESSION["nombre"])){
    ...
    <html lang="es">
      ...
      <body class="hold-transition sidebar-collapse sidebar-mini layout-fixed layout-navbar-fixed" idproyecto="<?php echo $_SESSION['idproyecto']; ?>">
        ...
        <script type="text/javascript" src="scripts/resumen_activos_fijos.js?version_jdl=1.1"></script>
        <script type="text/javascript" src="scripts/js_compra_insumo_repetido.js?version_jdl=1.1"></script>
