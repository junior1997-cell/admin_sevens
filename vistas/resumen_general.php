...
?>
  ...
  <body class="hold-transition sidebar-collapse sidebar-mini layout-fixed layout-navbar-fixed pace-orange" idproyecto="<?php echo $_SESSION['idproyecto']; ?>">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="col-lg-12 col-12">
                      <div class="text-primary p-l-10px" style="position: relative; top: 10px;"><label class="bg-white" for=""><b class="mx-2">Servicios Registrados</b></label></div>

                      <div class="row">
                        <div class="card-body mb-2" style="border-radius: 5px; box-shadow: 0 0 2px rgb(0 0 0), 0 1px 5px 4px rgb(255 255 255 / 60%);">
                          <div class="table-responsive">
                            <!--la tabla-->
                            <div id="tabla_detalle_servicio_maquina"></div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="text-primary p-l-10px" style="position: relative; top: 10px;"><label class="bg-white" for=""><b class="mx-2">Pagos</b></label></div>
                      <div class="row">
                        <div class="card-body" style="border-radius: 5px; box-shadow: 0 0 2px rgb(0 0 0), 0 1px 5px 4px rgb(255 255 255 / 60%);">
                          <div class="table-responsive">
                            <!-- tabla pagos -->
                            <div id="tabla_pagos_servicio_maquina"></div>
                          </div>
                        </div>
                      </div>
                    </div>
    ...
    <script type="text/javascript" src="scripts/resumen_general.js?version_jdl=2.06"></script>
