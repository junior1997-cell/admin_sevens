                    ...
                    <div class="col-12">
                      <div class="card card-primary card-outline">
                        <div class="card-header">
                          <h3 class="card-title">
                            <button type="button" class="btn bg-gradient-success" data-toggle="modal" data-target="#modal-agregar-material" ><i class="fas fa-plus-circle"></i> Agregar</button>
                            Manual de Usuario por modulos.
                          </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
