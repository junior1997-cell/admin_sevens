  ...
  if (!isset($_SESSION["nombre"])){
    ...
    <html lang="es">
      <head>
        ...
        <title>Pago Valorización | Admin Sevens</title>

        <?php $title = "Pago Valorización"; require 'template/head.php'; ?>
      ...
      <body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed pace-orange " idproyecto="<?php echo $_SESSION['idproyecto']; ?>">
        ...
        <script type="text/javascript" src="scripts/pago_valorizacion.js?version_jdl=2.07"></script>
