  ...
  if (!isset($_SESSION["nombre"])){
    ...
    <html lang="es">
      <head>
        ...
        <title>Otras facturas Proyecto | Admin Sevens</title>
        
        <?php $title = "Otras facturas Proyecto"; require 'template/head.php'; ?>
      ...
      <body class="hold-transition sidebar-collapse sidebar-mini layout-fixed layout-navbar-fixed pace-orange" idproyecto="<?php echo $_SESSION['idproyecto']; ?>">
            ...
            <div class="content-wrapper">
              ...
              <section class="content-header">
                <div class="container-fluid">
                  <div class="row mb-2">
                    <div class="col-sm-6">
                      <h1>Otras facturas por Proyecto</h1>
                    </div>
                    <div class="col-sm-6">
                      <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Otras facturas por Proyecto</li>
                      </ol>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="card card-primary card-outline">
                        <div class="card-header">
                          <h3 class="card-title">
                            ...
                            Administra de manera eficiente otras facturas por Proyecto.
                          </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                        ...
                        <form id="form-otras_facturas" name="form-otras_facturas" method="POST">
                          <div class="card-body">
                            <div class="row" id="cargando-1-fomulario">
                              ...
                              <input type="hidden" name="idotra_factura_proyecto" id="idotra_factura_proyecto" />
        ...
        <script type="text/javascript" src="scripts/otra_factura_proy.js?version_jdl=2.07"></script>
