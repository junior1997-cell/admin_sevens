  ...
  if (!isset($_SESSION["nombre"])){
    ...
    <html lang="es">
      ...
      <body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed pace-orange" idproyecto="<?php echo $_SESSION['idproyecto']; ?>">
                      ...
                      <div class="modal-body">
                        ...
                        <form id="form-fierro" name="form-fierro" method="POST">
                          <div class="row" id="cargando-1-fomulario">
                            ...
                            <!-- id valorizacion -->
                            <input type="hidden" name="idfierro_por_valorizacion" id="idfierro_por_valorizacion" />                            
                            <!-- fecha inicio -->
        ...
        <script type="text/javascript" src="scripts/valorizacion_fierro.js?version_jdl=2.07"></script>
