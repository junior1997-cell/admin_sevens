  ...
  if (!isset($_SESSION["nombre"])){
    ...
    <html lang="es">
      ...
      <body class="hold-transition sidebar-collapse sidebar-mini layout-fixed layout-navbar-fixed pace-orange" idproyecto="<?php echo $_SESSION['idproyecto']; ?>">
                      ...
                      <div class="card card-primary card-outline">
                        ...
                        <div class="card-header">
                          ...
                          <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-2" id="btn-factura" style="display: none;">
        ...
        <script type="text/javascript" src="scripts/servicio_equipos.js?version_jdl=2.03"></script>
