  ...
  if (!isset($_SESSION["nombre"])){
    ...
    <html lang="es">
      <head>
        ...
        <title>Maquinarias | Admin Sevens</title>

        <?php $title = "Maquinarias"; require 'template/head.php'; ?>
      ...
      <body class="hold-transition sidebar-collapse sidebar-mini layout-fixed layout-navbar-fixed pace-orange" idproyecto="<?php echo $_SESSION['idproyecto']; ?>">
        ...
        <script type="text/javascript" src="scripts/all_maquinaria.js?version_jdl=2.07"></script>
