  ...
  if (!isset($_SESSION["nombre"])){
    ...
    <html lang="es">
      ...
      <body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed pace-orange" idproyecto="<?php echo $_SESSION['idproyecto']; ?>">
        ...
        <!-- hora sesion-->
        <script src="../dist/js/sesion.js?version_jdl=2.02"></script> 

        <script type="text/javascript" src="scripts/calendario.js?version_jdl=2.02"></script>

        <!-- Funciones Crud -->
        <script type="text/javascript" src="../dist/js/funcion_crud.js?version_jdl=2.02"></script>
        <!-- Funciones Generales -->
        <script type="text/javascript" src="../dist/js/funcion_general.js?version_jdl=2.02"></script>
