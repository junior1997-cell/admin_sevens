...
if (!isset($_SESSION["nombre"])) {
  ...
  <body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed pace-orange" idproyecto="<?php echo $_SESSION['idproyecto']; ?>">
          ...
          <div class="content-header">
            <div class="container-fluid">
              <div class="row mb-2">
                <div class="col-sm-6">
                  <h1 class="m-0">
                    <i class="nav-icon fas fa-box-open"></i> Almacén Activos Fijos
                ...
                <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Almacén Activos Fijos</li>
                  </ol>
                </div>
                <!-- /.col -->
              </div>
    ...
    <script type="text/javascript" src="scripts/almacen_activos.js?version_jdl=2.02"></script>
