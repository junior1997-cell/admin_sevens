...
?>
  ...
  <head>
    ...
    <?php $title = "Almacenes Generales de Activos";
    require 'head.php';
  ...
  <body class="hold-transition sidebar-collapse sidebar-mini layout-fixed layout-navbar-fixed pace-orange" idproyecto="<?php echo $_SESSION['idproyecto']; ?>">
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header">
            <div class="container-fluid">
              <div class="row mb-2">
                <div class="col-sm-6">
                  <h1><i class="nav-icon fas fa-box-open"></i> Almacenes Generales de Activos</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <form id="form-almacen-general" name="form-almacen-general" method="POST">
                      <div class="card-body">
                        <div class="row" id="cargando-1-fomulario">
                          ...
                          <!-- <input type="hidden" name="tipo_almacen" id="tipo_almacen" value="Activos" />-->
    ...
    <script type="text/javascript" src="scripts/almacen_general_activos.js?version_jdl=2.06"></script>
