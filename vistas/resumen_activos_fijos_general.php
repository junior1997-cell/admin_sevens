  ...
  if (!isset($_SESSION["nombre"])){
    ...
    <html lang="es">
      <head>
        ...
        <title>Resumen de Activos Fijos General | Admin Sevens</title>

        <?php $title = "Resumen de Activos Fijos General"; require 'template/head.php';  ?>
      ...
      <body class="hold-transition sidebar-collapse sidebar-mini layout-fixed layout-navbar-fixed pace-orange" idproyecto="<?php echo $_SESSION['idproyecto']; ?>">
        ...
        <script type="text/javascript" src="scripts/resumen_activos_fijos_general.js?version_jdl=2.07"></script>      
