...
function init() {
  ...
  tabla_resumen();
  // ══════════════════════════════════════ S E L E C T 2 ══════════════════════════════════════
  lista_select2(`../ajax/almacen_activos.php?op=select2Productos&idproyecto=${idproyecto}`, '#producto_tup', null, '.cargando_producto_tup');         // transferencia uso de obra
  lista_select2(`../ajax/almacen_activos.php?op=select2ProductosMasEPP&idproyecto=${idproyecto}`, '#producto_tep', null, '.cargando_producto_tep');   // transferencia entre proyectos
  lista_select2(`../ajax/almacen_activos.php?op=select2ProductosMasEPP&idproyecto=${idproyecto}`, '#producto_tag', null, '.cargando_productos_tag');  // transferencia almacen general
  lista_select2(`../ajax/almacen_activos.php?op=select2Proyecto`, '#proyecto_tep', null, '.cargando_proyecto_tep');
...
function todos_almacen() {
  ...
  $.post("../ajax/almacen_activos.php?op=tabla_almacen", { 'id_proyecto': idproyecto, 'nombre_insumo': '', 'fip': fip, 'ffp':ffp, 'fpo': fpo }, function (e, status) {
...
function buscar_producto() {
  ...
  delay(function(){ // Retrasamos la busqueda  
    ...
    $.post("../ajax/almacen_activos.php?op=tabla_almacen", { 'id_proyecto': idproyecto_r, 'nombre_insumo': nombre_insumo, 'fip': fip_r, 'ffp':ffp_r, 'fpo': fpo_r }, function (e, status) {
...
function modal_ver_almacen(fecha, idalmacen_resumen, tipo_mov = '') {
  ...
  tabla_x_dia = $('#tabla-ver-almacen').dataTable({
    ...
    ajax:{
      url: `../ajax/almacen_activos.php?op=tbla-ver-almacen-detalle&idalmacen_resumen=${idalmacen_resumen}&fecha=${fecha}&tipo_mov=${tipo_mov}`,
      type : "get",
      dataType : "json",						
      error: function(e){
        console.log(e.responseText);  ver_errores(e);
...
function ver_editar_almacen_x_dia(id_almacen_s, idproducto) {
  ...
  $.post(`../ajax/almacen_activos.php?op=ver_almacen`, {'id_proyecto': localStorage.getItem("nube_idproyecto"), 'id_almacen_s': id_almacen_s, 'id_producto': idproducto }, function (e, textStatus, jqXHR) {
    e = JSON.parse(e);   console.log(e);
    if (e.status == true) {
...
function cambiar_producto_salida(val_input) {
  ...
  if (idproducto == '' || idproducto == null ) { } else {
    $.post(`../ajax/almacen_activos.php?op=ver_almacen`, {'id_proyecto': localStorage.getItem("nube_idproyecto"), 'id_almacen_s': id_almacen_s_r, 'id_producto': idproducto }, function (e, textStatus, jqXHR) {
      e = JSON.parse(e);   console.log(e);
      if (e.status == true) {          
        e.data.marca_array.forEach((val, key) => {
          if (val.marca == e.data.marca ) {
...
function guardar_y_editar_almacen_x_dia(e) {
  ...
  $.ajax({
    url: "../ajax/almacen_activos.php?op=guardar_y_editar_almacen_x_dia",
    type: "POST",
    data: formData,
    contentType: false,
    processData: false,
...
function eliminar_x_dia(idalmacen, cant, nombre) {
  ...
  crud_eliminar_papelera(
    "../ajax/almacen_activos.php?op=desactivar_x_dia",
    "../ajax/almacen_activos.php?op=eliminar_x_dia", 
    idalmacen, 
    "!Elija una opción¡", 
...
function limpiar_form_tup() {
  ...
  lista_select2(`../ajax/almacen_activos.php?op=select2Productos&idproyecto=${localStorage.getItem("nube_idproyecto")}`, '#producto_tup', null, '.cargando_producto_tup');
...
function add_producto_tup(data) {
  ...
  if (idproducto == null || idproducto == '' || idproducto === undefined) { } else {
    ...
    if ($(`#html_producto_tup div`).hasClass(`delete_multiple_${idproducto}`)) { // validamos si exte el producto agregado
      ...
      $.post(`../ajax/almacen_activos.php?op=marcas_x_producto`, {'id_producto':idproducto, 'id_proyecto': localStorage.getItem("nube_idproyecto") }, function (e, status, jqXHR) {
        e = JSON.parse(e);   //console.log(e);
        if (e.status == true) {
...
function guardar_y_editar_tup(e) {
  ...
  $.ajax({
    url: "../ajax/almacen_activos.php?op=guardar_y_editar_tup",
    type: "POST",
    data: formData,
    contentType: false,
    processData: false,
...
function limpiar_form_tep() {
  ...
  lista_select2(`../ajax/almacen_activos.php?op=select2Productos&idproyecto=${localStorage.getItem("nube_idproyecto")}`, '#producto_tep', null, '.cargando_producto_tep');
...
function guardar_y_editar_tep(e) {
  ...
  $.ajax({
    url: "../ajax/almacen_activos.php?op=guardar_y_editar_tep",
    type: "POST",
    data: formData,
    contentType: false,
    processData: false,
...
function limpiar_form_tag() {
  ...
  lista_select2(`../ajax/almacen_activos.php?op=select2Productos&idproyecto=${localStorage.getItem("nube_idproyecto")}`, '#producto_tag', null, '.cargando_productos_tag');
...
function add_producto_tag(data) {
  ...
  if (idproducto == null || idproducto == '' || idproducto === undefined) { } else {
    ...
    if ($(`#html_producto_tag div`).hasClass(`delete_multiple_${idproducto}`)) { // validamos si exte el producto agregado
      ...
      $.post(`../ajax/almacen_activos.php?op=otros_almacenes`, function (e, status, jqXHR) {
        e = JSON.parse(e);   //console.log(e);
        if (e.status == true) {
          e.data.forEach((val, key) => {
...
function guardar_y_editar_tag(e) {
  ...
  $.ajax({
    url: "../ajax/almacen_activos.php?op=guardar_y_editar_tag",
    type: "POST",
    data: formData,
    contentType: false,
    processData: false,
...
function guardar_y_editar_tm(e) {
  ...
  Swal.fire({
    ...
    preConfirm: (input) => {
      return fetch("../ajax/almacen_activos.php?op=guardar_y_editar_tm", {
        method: 'POST', // or 'PUT'
...
function tranferencia_masiva(unidad_medida, categoria, es_epp) {
  ...
  var idproyecto =  localStorage.getItem("nube_idproyecto"); 
  mostrar_masivo = true;
  $.get(`../ajax/almacen_activos.php?op=transferencia-masiva-almacen`, {id_proyecto: idproyecto, unidad_medida: unidad_medida, categoria:categoria, es_epp:es_epp},  function (e, textStatus, jqXHR) {
...
function reload_producto_todos(){ $('.comprado_todos').html(`(todos)`); lista_select2(`../ajax/almacen_activos.php?op=select2ProductosTodos&idproyecto=${localStorage.getItem("nube_idproyecto")}`, '#producto', null, '.cargando_productos'); }
function reload_producto_tup(){ lista_select2(`../ajax/almacen_activos.php?op=select2Productos&idproyecto=${localStorage.getItem("nube_idproyecto")}`, '#producto_tup', null, '.cargando_producto_tup'); }

function reload_proyecto_tep(){ lista_select2(`../ajax/almacen_activos.php?op=select2Proyecto`, '#proyecto_tep', null, '.cargando_proyecto_tep'); }
function reload_producto_tep(){ lista_select2(`../ajax/almacen_activos.php?op=select2ProductosMasEPP&idproyecto=${localStorage.getItem("nube_idproyecto")}`, '#producto_tep', null, '.cargando_producto_tep'); }

function reload_producto_tag(){ lista_select2(`../ajax/almacen_activos.php?op=select2Productos&idproyecto=${localStorage.getItem("nube_idproyecto")}`, '#producto_tag', null, '.cargando_productos_tag'); }
