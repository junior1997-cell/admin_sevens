...
function listar_pagos(idmaquinaria,idproyecto) {
  ...
  tabla3=$('#tabla-pagos').dataTable({
    ...
    buttons: ['copyHtml5', 'excelHtml5', 'csvHtml5','pdf', "colvis"],
    "ajax":{
        url: '../ajax/Servicio_equipos.php?op=listar_pagos&idmaquinaria='+idmaquinaria+'&idproyecto='+idproyecto,
        type : "get",
        dataType : "json",						
        error: function(e){
          console.log(e.responseText);	
...
function total_pagos(idmaquinaria,idproyecto) {
  $.post("../ajax/Servicio_equipos.php?op=suma_total_pagos", { idmaquinaria:idmaquinaria,idproyecto:idproyecto }, function (data, status) {
