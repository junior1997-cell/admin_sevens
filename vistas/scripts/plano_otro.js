...
function addDocs(e,id) {
  ...
  $("#"+id+"_ver").html('<i class="fas fa-spinner fa-pulse fa-6x"></i><br><br>');
	...
	var file = e.target.files[0], imageType = false;
                  ...
                  if ( extrae_extencion(file.name) == "pdf"  ) {
                    ...
                    if ( extrae_extencion(file.name) == "dwg" ) {
                      ...
                      if ( extrae_extencion(file.name) == "zip" || extrae_extencion(file.name) == "rar" || extrae_extencion(file.name) == "iso" ) {
                        ...
                        if ( extrae_extencion(file.name) == "jpeg" || extrae_extencion(file.name) == "jpg" || extrae_extencion(file.name) == "jpe" || extrae_extencion(file.name) == "jfif" || extrae_extencion(file.name) == "gif" || extrae_extencion(file.name) == "png" || extrae_extencion(file.name) == "tiff" || extrae_extencion(file.name) == "tif" || extrae_extencion(file.name) == "webp" || extrae_extencion(file.name) == "bmp" ) {
      
                          $("#"+id+"_ver").html('<img src="'+result+'" alt="" width="50%" >');
            
                        }else{
            
                          if ( extrae_extencion(file.name) == "docx" || extrae_extencion(file.name) == "docm" || extrae_extencion(file.name) == "dotx" || extrae_extencion(file.name) == "dotm" || extrae_extencion(file.name) == "doc" || extrae_extencion(file.name) == "dot"  ) {
              ...
              if ( extrae_extencion(data.doc) == "pdf" ) {
                ...
                if ( extrae_extencion(data.doc) == "dwg" ) {
                  ...
                  if ( extrae_extencion(data.doc) == "zip" || extrae_extencion(data.doc) == "rar" || extrae_extencion(data.doc) == "iso" ) {
                    ...
                    if ( extrae_extencion(data.doc) == "jpeg" || extrae_extencion(data.doc) == "jpg" || extrae_extencion(data.doc) == "jpe" || extrae_extencion(data.doc) == "jfif" || extrae_extencion(data.doc) == "gif" || extrae_extencion(data.doc) == "png" || extrae_extencion(data.doc) == "tiff" || extrae_extencion(data.doc) == "tif" || extrae_extencion(data.doc) == "webp" || extrae_extencion(data.doc) == "bmp" ) {

                      $("#doc1_ver").html('<img src="../dist/otros_docs/'+data.doc+'" alt="" width="50%" >');
        
                    }else{
        
                      if ( extrae_extencion(data.doc) == "docx" || extrae_extencion(data.doc) == "docm" || extrae_extencion(data.doc) == "dotx" || extrae_extencion(data.doc) == "dotm" || extrae_extencion(data.doc) == "doc" || extrae_extencion(data.doc) == "dot"  ) {
              ...
              if ( extrae_extencion(dr) == "pdf" ) {
                ...
                if ( extrae_extencion(dr) == "dwg" ) {
                  ...
                  if ( extrae_extencion(dr) == "zip" || extrae_extencion(dr) == "rar" || extrae_extencion(dr) == "iso" ) {
                    ...
                    if ( extrae_extencion(dr) == "jpeg" || extrae_extencion(dr) == "jpg" || extrae_extencion(dr) == "jpe" || extrae_extencion(dr) == "jfif" || extrae_extencion(dr) == "gif" || extrae_extencion(dr) == "png" || extrae_extencion(dr) == "tiff" || extrae_extencion(dr) == "tif" || extrae_extencion(dr) == "webp" || extrae_extencion(dr) == "bmp" ) {
            ...
            if ( extrae_extencion(pdffile.name) == "pdf" ) {
              ...
              if ( extrae_extencion(pdffile.name) == "dwg" ) {
                ...
                if ( extrae_extencion(pdffile.name) == "zip" || extrae_extencion(pdffile.name) == "rar" || extrae_extencion(pdffile.name) == "iso" ) {
                  ...
                  if ( extrae_extencion(pdffile.name) == "jpeg" || extrae_extencion(pdffile.name) == "jpg" || extrae_extencion(pdffile.name) == "jpe" || extrae_extencion(pdffile.name) == "jfif" || extrae_extencion(pdffile.name) == "gif" || extrae_extencion(pdffile.name) == "png" || extrae_extencion(pdffile.name) == "tiff" || extrae_extencion(pdffile.name) == "tif" || extrae_extencion(pdffile.name) == "webp" || extrae_extencion(pdffile.name) == "bmp" ) {
                    ...
                    if ( extrae_extencion(pdffile.name) == "docx" || extrae_extencion(pdffile.name) == "docm" || extrae_extencion(pdffile.name) == "dotx" || extrae_extencion(pdffile.name) == "dotm" || extrae_extencion(pdffile.name) == "doc" || extrae_extencion(pdffile.name) == "dot"  ) {
