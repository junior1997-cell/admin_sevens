...
function init() {
  ...
  $("#lOtraFacturaProy").addClass("active bg-primary");
...
function total() {
  ...
  $.post("../ajax/otra_factura_proy.php?op=total", {}, function (e, status) {
...
function guardaryeditar(e) {
  ...
  $.ajax({
    url: "../ajax/otra_factura_proy.php?op=guardaryeditar",
    type: "POST",
    data: formData,
    contentType: false,
    processData: false,
...
function mostrar(idotra_factura_proyecto) {
  ...
  $.post("../ajax/otra_factura_proy.php?op=mostrar", { idotra_factura_proyecto: idotra_factura_proyecto }, function (e, status) {
    ...
    if (e.status == true) {
      ...
      $("#razon_social").val(e.data.razon_social).trigger("change");

      $("#forma_pago").val(e.data.forma_de_pago).trigger("change");
      $("#glosa").val(e.data.glosa).trigger("change");
      $("#idotra_factura_proyecto").val(e.data.idotra_factura_proyecto);
...
function verdatos(idotra_factura_proyecto){
...
function eliminar(idotra_factura_proyecto, nombre ) {
  console.log(idotra_factura_proyecto, nombre);
  crud_eliminar_papelera(
    "../ajax/otra_factura_proy.php?op=desactivar",
    "../ajax/otra_factura_proy.php?op=eliminar", 
    idotra_factura_proyecto, 
    "!Elija una opción¡", 
