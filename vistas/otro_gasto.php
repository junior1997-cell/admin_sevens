  ...
  if (!isset($_SESSION["nombre"])){
    ...
    <html lang="es">
      <head>
        ...
        <?php $title = "Otros Gastos"; require 'template/head.php'; ?>
      ...
      <body class="hold-transition sidebar-collapse sidebar-mini layout-fixed layout-navbar-fixed pace-orange" idproyecto="<?php echo $_SESSION['idproyecto']; ?>">
                          ...
                          <div class="card-body">
                            <div class="row" id="cargando-1-fomulario">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:20px;">
                                <div class="progress" id="barra_progress_otro_gasto_div">
                                  <div id="barra_progress_otro_gasto" class="progress-bar" role="progressbar" aria-valuenow="2" aria-valuemin="0" aria-valuemax="100" style="min-width: 2em; width: 0%;">
                                    0%
                                  </div>
                                </div>
                              </div>
        ...
        <script type="text/javascript" src="scripts/otro_gasto.js?version_jdl=2.07"></script>
