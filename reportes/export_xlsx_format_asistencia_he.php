  ...
  if ($fecha_pago_obrero == 'semanal') {   
    ...
    foreach ($data_asistencia['data'] as $key => $reg) {
      ...
      foreach ($reg['asistencia'] as $key3 => $val3) {
        $hojaActiva->setCellValue($dias_sem[$key3] . $fila_1, $val3['horas_extras_dia']); 
      ...
      $hojaActiva->setCellValue('O' . $fila_1, $reg['total_he']);                 # total HN
      $hojaActiva->setCellValue('P' . $fila_1, $reg['total_dias_asistidos_he']);  # Total dias
    ...
    foreach ($data_asistencia['data'] as $key => $reg) {
      ...
      $hojaActiva->setCellValue('V' . $fila_1, $reg['total_dias_asistidos_he']);   # Total dias
      ...
      $hojaActiva->setCellValue('Z' . $fila_1, $reg['pago_quincenal_he']);   # Pago Semanl o Quincenal
